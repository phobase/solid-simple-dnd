...
test.describe('given I have horizontal Draggable', () => {
  test('then it should move horizontally only', async ({ page }) => {
    await page.goto(getStorybookUrl('draggable-horizontal'));
